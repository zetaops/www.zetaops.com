(function (e, t, n, r) {
    ...
    i(["foundation-mq-small", "foundation-mq-medium", "foundation-mq-large", "foundation-mq-xlarge", "foundation-mq-xxlarge", "foundation-data-attribute-namespace"]);
    e(function () {
    ...
    Foundation.libs.offcanvas = {
        ...
        events: function () {
            ...
            t(this.scope).off(".offcanvas").on("click.fndtn.offcanvas", ".left-off-canvas-toggle", function (t) {
                ...
                if (i.close_on_click) {
                    e.hide.call(e, n + r, e.get_wrapper(t))
                }
                ...
                if (r.close_on_click) {
                    e.hide.call(e, n + i, e.get_wrapper(t))
                }
            }).on("click.fndtn.offcanvas", ".exit-off-canvas", function (t) {
                e.click_remove_class(t, n + i);
                if (r)e.click_remove_class(t, n + r)
            })
        },
        toggle: function (e, t) {
            t = t || this.get_wrapper();
            if (t.is("." + e)) {
                this.hide(e, t)
            } else {
                this.show(e, t)
        ...
        show: function (e, t) {
            t = t || this.get_wrapper();
            t.trigger("open").trigger("open.fndtn.offcanvas");
            t.addClass(e)
        },
        hide: function (e, t) {
            t = t || this.get_wrapper();
            t.trigger("close").trigger("close.fndtn.offcanvas");
            t.removeClass(e)
        },
        ...
        get_settings: function (e) {
            ...
            return t.data(this.attr_name(true) + "-init") || this.settings
        },
        get_wrapper: function (e) {
            var t = this.S(e ? e.target : this.scope).closest(".off-canvas-wrap");
            if (t.length === 0) {
                t = this.S(".off-canvas-wrap")
            }
            return t
        },
        reflow: function () {
