...
window.averta = {}, function (n) {
    ...
    "use strict";
    var t = "ontouchstart"in document, u = window.navigator.pointerEnabled, f = !u && window.navigator.msPointerEnabled, r = u || f, h = (u ? "pointerdown " : "") + (f ? "MSPointerDown " : "") + (t ? "touchstart " : "") + "mousedown", e = (u ? "pointermove " : "") + (f ? "MSPointerMove " : "") + (t ? "touchmove " : "") + "mousemove", o = (u ? "pointerup " : "") + (f ? "MSPointerUp " : "") + (t ? "touchend " : "") + "mouseup", s = (u ? "pointercancel " : "") + (f ? "MSPointerCancel " : "") + "touchcancel", i;
    averta.TouchSwipe = function (n) {
        this.$element = n, this.enabled = !0, n.bind(h, {target: this}, this.__touchStart), n[0].swipe = this, this.onSwipe = null, this.swipeType = "horizontal", this.lastStatus = {}
        ...
        if (u.enabled) {
            ...
            u.touchStarted || (u.start_x = t ? i.touches[0].pageX : r ? i.pageX : f.pageX, u.start_y = t ? i.touches[0].pageY : r ? i.pageY : f.pageY, u.start_time = (new Date).getTime(), n(document).bind(o, {target: u}, u.__touchEnd).bind(e, {target: u}, u.__touchMove).bind(s, {target: u}, u.__touchCancel), c = t ? i.touches[0] : r ? i : f, h = u.createStatusObject(c), h.phase = "start", u.onSwipe.call(null, h), t || f.preventDefault(), u.lastStatus = h, u.touchStarted = !0)
        }
    }, i.__touchMove = function (n) {
        var i = n.data.target, e = n, u, f;
    ...
    n.changeTo = function (n, t, i, r, u) {
        if (this.stopped = !1, this._internalStop(), n = this._checkLimits(n), i = Math.abs(i || 0), this.options.snapping && (r = r || this.getSnapNum(n), u !== !1 && this._callsnapChange(r), this.current_snap = r), t) {
            this.animating = !0;
            var f = this, e = ++f.__animID, h = n - f.value, c = 0, l = n, o = 1 - f.options.friction, a = o + (i - 20) * o * 1.3 / f.options.maxSpeed, s = function () {
                if (e === f.__animID) {
                    var t = n - f.value;
                    if (Math.abs(t) > f.options.minValidDist && f.animating)window.requestAnimationFrame(s); else {
    ...
    t.__playAnimation = function (n, t) {
        ...
        if (this.$element.css("display", "none").removeAttr("data-delay").removeAttr("data-effect").removeAttr("data-duration").removeAttr("data-type"), this.$element.data("resize") !== undefined && (this.resizable = this.$element.data("resize"), this.$element.removeAttr("data-resize")), this.$element.data("fixed") !== undefined && (this.fixed = this.$element.data("fixed"), this.$element.removeAttr("data-fixed")), this.$element.data("widthlimit") !== undefined && (this.minWidth = this.$element.data("widthlimit"), this.$element.removeAttr("data-widthlimit")), this.end_anim.name || (this.end_anim.name = this.start_anim.name), this.end_anim.time && (this.autoHide = !0), this.$element.data("action") !== undefined && (u = this.slide.slider.slideController, this.$element.on("click", function (t) {
            ...
            var f = r.charAt(0), e = r.charAt(1), t = this.$element.data("offset-x"), i = this.$element.data("offset-y");
        ...
        var n = this._paraX - this._lastParaX, t = this._paraY - this._lastParaY;
        ...
        var u = this.slide.$layers, i = parseFloat(u.css("width")), f = parseFloat(u.css("height")), t, r, n;
    ...
    t._showTT = function () {
        ...
        var i = this.tt.outerHeight(!1), n = Math.max(this.tt.outerWidth(!1), parseInt(this.tt.css("max-width"))), t = window.innerWidth, r = window.innerHeight;
        switch (this.align) {
            case"top":
    ...
    var n = MSButtonLayer.prototype, t = MSLayerElement.prototype, i = ["top", "left", "bottom", "right"];
    n.create = function () {
    ...
    t.onSwipeStart = function () {
        ...
        if (this.hasParallaxLayer)if (this.slider.options.parallaxMode === "swipe")this.view.addEventListener(MSViewEvents.SCROLL, this.swipeParallaxMove, this); else this.$element.on("mousemove", {that: this}, this.mouseParallaxMove).on("mouseleave", {that: this}, this.resetParalax)
        ...
        var t = n.data.that, u = t.$element.offset(), f = t.slider, i, r;
        ...
        var t, n, i;
        if (!this.ls)for (this.ls = !0, this.preloadCount === 0 && this.___onlayersReady(), this.bgvideo && this.bgvideo.load(), this.hasBG && this.bg_src && (t = this, this.$bg_img.preloadImg(this.bg_src, function (n) {
            t._onBGLoad(n)
    ...
    window.MasterSlider = function () {
        ...
        var t, r, i;
        if (!this.preventInit) {
            if (this.initialized = !0, this.options.preload !== "all" && this._removeLoading(), this.options.shuffle && this._shuffleSlides(), MSLayerEffects.setup(), this.slideController.setupView(), this.view = this.slideController.view, this.$controlsCont = n("<div><\/div>").addClass("ms-inner-controls-cont"), this.options.centerControls && this.$controlsCont.css("max-width", this.options.width + "px"), this.$controlsCont.prepend(this.view.$element), this.$msContainer = n("<div><\/div>").addClass("ms-container").prependTo(this.$element).append(this.$controlsCont), this.controls)for (t = 0, r = this.controls.length; t < r; ++t)this.controls[t].setup();
    ...
    t.__snapCompelet = function () {
        ...
        var u, t, f, r, n;
        if (this.autoUpdateZIndex)if (t = this.viewSlidesList.length, f = Math.floor(t / 2), this.loop)for (r = this.viewSlidesList.indexOf(this.currentSlide), n = 0; n !== t; n++)u = this.viewSlidesList[n], this.viewSlidesList[n].$element.css("z-index", n <= r ? n + 1 : t - n); else {
            var i = this.currentSlide.index - this.viewSlidesList[0].index, e = t - i, o = i - e;
    ...
    n.__updateSlides = function (n, t) {
        var r = Math.abs(t / this[this.__dimension]), i = n.$element[0];
    ...
    t.slideAction = function () {
        ...
        this.cont = this.options.insertTo ? n(this.options.insertTo) : this.slider.$controlsCont, this.options.overVideo || this._hideOnvideoStarts(), this.options.hideUnder && (n(window).bind("resize", {that: this}, this.onResize), this.onResize(), this.needsRealign = !this.options.insetTo && (this.options.align === "left" || this.options.align === "right") && this.options.inset === !1)
    ...
    i.extend(BaseControl), t = i.prototype, r = BaseControl.prototype, t.setup = function () {
        ...
        var i = n(t.$element.find(".ms-thumb")), f = this, r = n("<div><\/div>").addClass("ms-thumb-frame").append(i).append(n('<div class="ms-thumb-ol"><\/div>')).bind("click", function () {
            f.changeSlide(r)
        }), u;
    ...
    window.MSGallery = function (t, i) {
        this.id = t, this.slider = i, this.telement = n("#" + t), this.botcont = n("<div><\/div>").addClass("ms-gallery-botcont").appendTo(this.telement), this.thumbcont = n("<div><\/div>").addClass("ms-gal-thumbcont hide-thumbs").appendTo(this.botcont), this.playbtn = n("<div><\/div>").addClass("ms-gal-playbtn").appendTo(this.botcont), this.thumbtoggle = n("<div><\/div>").addClass("ms-gal-thumbtoggle").appendTo(this.botcont), i.control("thumblist", {
            ...
            insertTo: this.botcont,
            autohide: !1
        }), i.control("timebar", {insertTo: this.botcont, autohide: !1}), i.control("bullets", {
            insertTo: this.botcont,
            autohide: !1
        })
    };
    ...
    window.MSFlickrV2 = function (t, i) {
        var e = {count: 10, type: "photoset", thumbSize: "q", imgSize: "c"}, r;
        ...
        var r = this, u = this.options.author || this.options.desc;
    ...
    window.MSFacebookGallery = function (t, i) {
        var u = {count: 10, type: "photostream", thumbSize: "320", imgSize: "orginal", https: !1}, r;
        ...
        for (var i = 0, r = n.length; i !== r; i++)if (n[i].source.indexOf(t + "x" + t) !== -1)return n[i].source;
        return n[r - 3].source
    }, r = {
        image: function (n, t) {
    ...
    t.init = function () {
        ...
        n(window).on("scroll", {that: this}, this.moveParallax).trigger("scroll")
    }, t.resetLayers = function () {
        if (this.lastSlide) {
        ...
        var i = t.data.that, f = i.slider, e = i.sliderOffset, o = n(window).scrollTop(), r = i.currentSlide.$scrollParallaxCont, s = i.currentSlide.$imgcont, u = e - o;
