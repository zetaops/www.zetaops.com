window.Modernizr = function (e, t, n) {
    ...
    var u, l, f, d = "2.8.2", p = {}, m = !0, h = t.documentElement, v = "modernizr", g = t.createElement(v), y = g.style, b = ({}.toString, " -webkit- -moz- -o- -ms- ".split(" ")), E = "Webkit Moz O ms", w = E.split(" "), C = E.toLowerCase().split(" "), S = {svg: "http://www.w3.org/2000/svg"}, j = {}, x = [], N = x.slice, k = function (e, n, r, o) {
        var i, a, c, s, u = t.createElement("div"), l = t.body, f = l || t.createElement("body");
    ...
    return p.addTest = function (e, t) {
        ...
        var u, l, f = "3.7.0", d = e.html5 || {}, p = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, m = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, h = "_html5shiv", v = 0, g = {};
        !function () {
            try {
    ...
    function s(e, n, r, o, i, s, u) {
        ...
        var u = u || d.errorTimeout, f = t.createElement(e), p = 0, v = 0, b = {t: r, s: n, e: i, a: s, x: u};
    ...
    var f, d, p = t.documentElement, m = e.setTimeout, h = t.getElementsByTagName("script")[0], v = {}.toString, g = [], y = 0, b = "MozAppearance"in p.style, E = b && !!t.createRange().compareNode, w = E ? p : h.parentNode, p = e.opera && "[object Opera]" == v.call(e.opera), p = !!t.attachEvent && !p, C = b ? "object" : p ? "script" : "img", S = p ? "script" : C, j = Array.isArray || function (e) {
    ...
    d = function (e) {
        function t(e) {
            var t, n, r, e = e.split("!"), o = x.length, i = e.pop(), a = e.length, i = {
                url: i,
                origUrl: i,
                prefixes: e
            };
        ...
        function c(e, t) {
            function n(e, n) {
                if (e) {
                    if (o(e))n || (f = function () {
                        ...
                        d.apply(this, e), p()
                    }), a(e, f, t, 0, u); else if (Object(e) === e)for (s in c = function () {
                        var t, n = 0;
            ...
            var c, s, u = !!e.test, l = e.load || e.both, f = e.callback || i, d = f, p = e.complete || i;
            n(u ? e.yep : e.nope, !!l), l && n(l)
        }

        var s, u, f = this.yepnope.loader;
        if (o(e))a(e, 0, f, 0); else if (j(e))for (s = 0; s < e.length; s++)u = e[s], o(u) ? a(u, 0, f, 0) : j(u) ? d(u) : Object(u) === u && c(u, f); else Object(e) === e && c(e, f)
        ...
        var u, o = t.createElement("link"), n = s ? c : n || i;
